...
var btnShowSelector = document.querySelector(".js-show-menu");

function showMenuMob() {
  var mobDropMenu = document.querySelector(".js-mob-drop-menu");
  btnShowSelector.classList.toggle('active');
  mobDropMenu.classList.toggle('active');
}

btnShowSelector.addEventListener("click", showMenuMob); //slider 
...
(function () {
  ...
  function handleFormSubmit(form, input) {
    ...
    var errors = validate(form, constraints); // then we update the form to reflect the results
  ...
  function showSuccess() {
    // We made it \:D/
    var form_inner = document.querySelector(".js-form-success");
